/**
 * OKX DeFi Command Center ΓÇö Premium Dashboard
...
// ΓöÇΓöÇΓöÇ Design tokens ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const C = {
  bg:        "#06070f",
  surface:   "#0b0d1a",
  surfaceUp: "#10122080",
...
// ΓöÇΓöÇΓöÇ Global CSS injection ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const GLOBAL_CSS = `
...
// ΓöÇΓöÇΓöÇ Helper components ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Main App ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
export default function App() {
  ...
  const tabs = [
    { id: "portfolio", label: "Portfolio",  icon: "Γùê" },
    { id: "signals",   label: "Signals",    icon: "Γùë" },
    { id: "alerts",    label: "Alerts",     icon: "Γù¼", count: alerts.length },
    { id: "swap",      label: "AI Swap",    icon: "Γƒü" },
  ];
  ...
  return (
    <>
      ...
      <div className="grid-bg" style={{ minHeight: "100vh", padding: "0" }}>
        ...
        {/* ΓöÇΓöÇ Top nav bar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        <nav style={{
        ...
        {/* ΓöÇΓöÇ Main layout ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "28px 32px" }}>
          ...
          {/* ΓòÉΓòÉ PORTFOLIO TAB ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
          {tab === "portfolio" && (
            <div className="fade-up">
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, marginBottom: 20 }}>
                <StatCard
                  ...
                  value={totalUsd ? `$${totalUsd.toLocaleString("en-US", { maximumFractionDigits: 2 })}` : "ΓÇö"}
                  sub={`${portfolio?.portfolio?.token_count || 0} assets ┬╖ multi-chain`}
                  icon="Γùê" color={C.cyan} glow="glow-cyan"
                />
                <StatCard
                  label="Risk Score"
                  value={riskScore !== null ? `${riskScore}` : "ΓÇö"}
                        ...
                        <div className="data-row" style={{ display: "grid", gridTemplateColumns: "36px 1fr 100px 100px 80px 100px", gap: 12, alignItems: "center" }}>
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: "0.68rem", color: C.textSec, fontFamily: "'JetBrains Mono', monospace" }}>
                              {token.contract === "native" ? "Native" : token.contract.slice(0, 10) + "ΓÇª"}
                            </div>
                          </div>
          ...
          {/* ΓòÉΓòÉ SIGNALS TAB ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
          {tab === "signals" && (
            <div className="fade-up">
              <div className="grad-border" style={{ padding: "24px" }}>
                <SectionHeader title="Live DeFi Signals ΓÇö OKX Market Feed" right={<LiveDot />} />
          ...
          {/* ΓòÉΓòÉ ALERTS TAB ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
          {tab === "alerts" && (
            <div className="fade-up">
                ...
                <div className="grad-border" style={{ padding: "24px" }}>
                  ...
                  {alerts.length === 0 && (
                    <div style={{ padding: "32px 0", textAlign: "center" }}>
                      <div style={{ fontSize: "2rem", marginBottom: 8 }}>Γ£ô</div>
                    ...
                    {alerts.map((alert, i) => (
                      <div key={i}
                        ...
                        <div style={{
                          ...
                          {alert.type === "CONCENTRATION" ? "Γèù" : alert.type === "PRICE_MOVEMENT" ? "Γƒü" : "Γù¼"}
                        </div>
                        <div style={{ flex: 1 }}>
          ...
          {/* ΓòÉΓòÉ SWAP TAB ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
          {tab === "swap" && (
            <div className="fade-up">
              <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", gap: 16 }}>
                ...
                <div className="grad-border" style={{ padding: "28px" }}>
                  ...
                  <button
                    ...
                    onClick={handleSwap}
                    disabled={loading}>
                    {loading ? "Γƒ│  PROCESSINGΓÇª" : "Γƒü  EXECUTE SWAP VIA OKX DEX"}
                  </button>
